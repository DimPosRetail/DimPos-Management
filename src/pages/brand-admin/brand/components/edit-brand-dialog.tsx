...
{
    const { editBrandMutation } = useBrand();
    ...
    const onSubmit = async ( data: TUpdateBrand ) =>
    {
        try
        {
            await editBrandMutation.mutateAsync( data );
                ...
                <Form { ...form }>
                    <form onSubmit={ form.handleSubmit( onSubmit ) } className="space-y-4">
                                ...
                                <FormField
                                    ...
                                    render={ ( { field } ) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input disabled={ editBrandMutation.isPending } placeholder="Nhập tên thương hiệu" { ...field } />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    ) }
                                ...
                                <FormField
                                    ...
                                    render={ ( { field } ) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input disabled={ editBrandMutation.isPending } placeholder="Nhập số điện thoại" { ...field } />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    ) }
                                ...
                                <FormField
                                    ...
                                    render={ ( { field } ) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input disabled={ editBrandMutation.isPending } placeholder="Nhập địa chỉ" { ...field } />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    ) }
                        ...
                        <DialogFooter>
                            ...
                            >
                                { editBrandMutation.isPending ? "Đang lưu..." : "Lưu thay đổi" }
                            </Button>
                        </DialogFooter>
                    </form>
                </Form>

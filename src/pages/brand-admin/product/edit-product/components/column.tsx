...
export const extraProductColumns: ColumnDef<TProductExtra>[] = [
    {
        accessorKey: "code",
        ...
        cell: ( info ) =>
        {
            ...
            return (
                <div className="flex items-center gap-2">
                    <Badge variant="outline" className="text-base font-normal max-w-[120px] text-ellipsis">
                        { code }
                    </Badge>
                    <Button
                        variant="ghost"
            ...
            return (
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        size="sm"
                        className="h-6 w-6 p-0 hover:bg-muted"
                        onClick={ () => copyToClipboard( sku, "Mã sản phẩm" ) }
                    >
                        <Copy className="h-3 w-3" />
                    </Button>
                </div>
    ...
    {
        accessorKey: "name",
        header: () => <div className="font-semibold text-base ">Tên Sản Phẩm Phụ</div>,
        cell: ( info ) =>
        {
            const name = info.getValue() as string;
            return (
    ...
    },
    {
        ...
        header: () =>
        {
            return <div className="font-semibold text-center text-base ">TT Hiển thị</div>;
        },
        cell: ( info ) =>
        {
    ...
    {
        accessorKey: "price",
        header: () => <div className="text-center font-semibold text-base">Giá gốc</div>,
        cell: ( info ) =>
        {
    ...
    },
    {
        ...
        cell: ( info ) =>
        {
            ...
            return (
                <div className="flex justify-center">
                    <div
                        className={ `flex items-center gap-1.5 px-3 py-1 rounded text-base font-normal ${ isActive ? "bg-green-mint-10 text-green-mint-100" : "bg-red-10 text-red-100"
                            }` }
                    >
                        { isActive ? <>Hoạt động</> : <>Không hoạt động</> }
                    </div>
...
export const selectedExtraProductColumns: ColumnDef<TProductExtra>[] = [
    {
        id: "select",
        header: ( { table } ) => (
            <RowSelectHeader table={ table } />

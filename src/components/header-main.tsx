...
import { AlertCircle, ChevronLeft, Info, Loader2, LogOut, Moon, Settings, Sun, Trash2, UserCog2 } from "lucide-react"
                ...
                <div className="flex items-center gap-2">
                    ...
                    <DropdownMenu onOpenChange={ handleNotificationDropdownOpen }>
                        ...
                        <DropdownMenuContent align="end" className="w-80">
                            ...
                            {/* Action buttons - only show if we have notifications */ }
                            { notifications.length > 0 && (
                                <>
                                    <DropdownMenuSeparator />
                                    <div className="p-2">
